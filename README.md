...
ah-cli ships a [`SKILL.md`](.agents/skills/ah-cli/SKILL.md) — install it into Claude Code, Cursor, Codex, or any compatible agent so your assistant can drive ah-cli for you:
